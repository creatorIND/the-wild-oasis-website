...
export default function Page() {
	return (
		<main className="space-y-8 text-base md:text-lg p-2">
			<section className="space-y-2">
				<h1 className="font-semibold text-2xl md:text-3xl lg:text-4xl text-accent-400">
					Privacy Policy
				</h1>
				<p className="font-light">Last updated: February 22, 2025</p>
			</section>
			...
			<section className="space-y-4">
				<h2 className="text-xl md:text-2xl lg:text-3xl text-primary-300">
					Interpretation and Definitions
				</h2>
				<div className="space-y-2">
					<h3 className="text-lg md:text-xl lg:text-2xl text-primary-300">
						Interpretation
					</h3>
					<p>
					...
					<div>
						...
						<ul className="list-disc pl-8 space-y-2 mt-2">
							...
							<li>
								...
								&quot;the Company&quot;, &quot;We&quot;,
								&quot;Us&quot; or &quot;Our&quot; in this
								Agreement) refers to The Wild Oasis.
							</li>
							<li>
							...
							<li>
								<strong>Website</strong> refers to The Wild
			...
			<section className="space-y-4">
				<h2 className="font-medium text-xl md:text-2xl lg:text-3xl text-primary-300">
				...
				<div className="space-y-2">
					...
					<div className="space-y-2">
						<h4 className="underline decoration-1 underline-offset-4 text-lg lg:text-xl text-primary-300">
							Personal Data
						</h4>
						<div>
					...
					<div>
						...
						<ul className="list-disc pl-8 space-y-2 mt-2">
							...
							<li>
								...
								with news, special offers and general
								information about other goods, services and
					...
					<div>
						...
						<ul className="list-disc pl-8 space-y-2 mt-2">
							<li>
								...
								Service Providers to monitor and analyze the use
							...
							<li>
								...
								other subsidiaries, joint venture partners or
							...
							<li>
								...
								such information may be viewed by all users and
								may be publicly distributed outside.
							</li>
							<li>
								<strong>With Your consent: </strong>
								We may disclose Your personal information for
